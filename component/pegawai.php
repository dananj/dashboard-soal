...
{
    //tidak ada property pada class pegawai
    //method
    ...
    public function tambahData($data)
    {
        ...
        $query = "INSERT INTO tabel_pegawai VALUES('','$nama_pegawai', '$umur','$alamat_pegawai','$jabatan_pegawai','$id_departemen','$foto_pegawai')";
    ...
    public function tambahHotel($data)
    {
        ...
        $bintang = htmlspecialchars($data['bintang']);
        $manager = htmlspecialchars($data['manager']);
       
        $gambar = $this->uploadHotel();
		if ( !$gambar ) {
		 	return false;
		 } 
        $query = "INSERT INTO hotel VALUES('','$nama','$bintang','$manager','$gambar')";
    ...
    public function deleteDataHotel($id)
    {
        ...
        mysqli_query($this->conn, "DELETE FROM hotel WHERE id = $id");
